...
import { chartOptions } from './PriceChart.config'   //, dummyData   chartOptions
import {
...
const showPriceChart = (priceChart) => {
  return(
    <div className="price-chart">
      <div className="price">
        <h4>BCP/ETH &nbsp; {priceSymbol(priceChart.lastPriceChange)} &nbsp; {priceChart.lastPrice}</h4>
      </div>
    ...
    return (
      <div className="card bg-dark text-white">
        <div className="card-header">
          Price Chart<button id="prC">BTN</button>
        </div>
